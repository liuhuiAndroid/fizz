...
import com.sec.common.constant.AdapterNotifyConst
...
class SortedRecyclerAdapter(
    ...
    fun notifyItemSortAtPosition(position: Int, payload: String = AdapterNotifyConst.UPDATE) {
    ...
    fun submitLoadingCell(
        loadingCell: SortedItemCell = DefaultLoadingCell()
    ) {
     ...
     */
    fun submitEmptyCell(
        emptyCell: SortedItemCell = DefaultEmptyCell()
    ) {
        finishLoading()
